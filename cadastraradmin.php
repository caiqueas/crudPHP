...
<div class="container">  
    <form id="contact" action="criarprocessamento.php" method="POST">
      <h3>Cadastro de administradores</h3>
      <h4>Cadastre novos administradores através do formulário abaixo</h4>
      <fieldset>
        <input placeholder="Nome do administrador" type="text" name="nome" id="nome"   tabindex="1" required>
      </fieldset>
      <fieldset>
        <input  placeholder="Email do administrador" type="email" name="email" id="email" tabindex="2" required>
      </fieldset>
      <fieldset>
        <input  placeholder="Senha do admin" type="password" name="senha" id="senha" tabindex="3" required>
      </fieldset>
      <fieldset>
